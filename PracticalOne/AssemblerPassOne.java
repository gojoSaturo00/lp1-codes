...
public class AssemblerPassOne {
	...
	static void pass1() throws Exception {
		BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("/Users/lokeshkhabiya/ThirdYearStuff/SPOS/SPOS-Practical/spos-assignment-1-part-1/input.txt")));
		out_pass1 = new PrintWriter(new FileWriter("/Users/lokeshkhabiya/ThirdYearStuff/SPOS/SPOS-Practical/spos-assignment-1-part-1/output_pass1.txt"), true);
		PrintWriter out_symtable = new PrintWriter(new FileWriter("/Users/lokeshkhabiya/ThirdYearStuff/SPOS/SPOS-Practical/spos-assignment-1-part-1/symtable.txt"), true);
		PrintWriter out_littable = new PrintWriter(new FileWriter("/Users/lokeshkhabiya/ThirdYearStuff/SPOS/SPOS-Practical/spos-assignment-1-part-1/littable.txt"), true);
		String s;
	...
	static void initializeTables() throws Exception {
		...
		String s,mnemonic;
		BufferedReader br;
		br = new BufferedReader(new InputStreamReader(new FileInputStream("/Users/lokeshkhabiya/ThirdYearStuff/SPOS/SPOS-Practical/spos-assignment-1-part-1/mot.txt")));
